<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true" CodeBehind="Category.aspx.cs" Inherits="FastFoodPractise.Admin.Category" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="pcoded-inner-content pt-0">
        <div class="align-aligh-self-end">
                                        ...
                                        <div class="col-sm-6 col-md-4 col-lg-4">
                                            ...
                                            <div>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div>
                                                        <asp:FileUpload runat="server" ID="fuCategoryImage" CssClass="form-control"
                                            ...
                                            <div class="card-block table-border-style">
                                                <div class="table-responsive">
                                                    ...
                                                    <asp:Repeater ID="rCategory" runat="server"
                                                        OnItemCommand="rCategory_ItemCommand" OnItemDataBound="rCategory_ItemDataBound">
                                                        <HeaderTemplate>
