<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true" CodeBehind="Product.aspx.cs" Inherits="FastFoodPractise.Admin.Product" %>
                                     ...
                                     <div class="col-sm-6 col-md-4 col-lg-4">
                                         ...
                                         <div>
                                             ...
                                             <div class="form-group">
                                                 ...
                                                 <div>
                                                     ...
                                                     <asp:RegularExpressionValidator ID="RegularExpressionValidator2" runat="server"
                                                         ErrorMessage="Price must not be negative" ForeColor="Red" Display="Dynamic"
                                                         SetFocusOnError="true"
                                             ...
                                             <div class="form-check pl-4">
                                                 ...
                                                 <div>
                                                     <asp:Image ID="imgProduct" runat="server" CssClas="img-thumbnail"></asp:Image>
                                                 </div>
                                             </div>
                                         </div>
                                     </div>
