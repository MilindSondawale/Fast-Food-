<%@ Page Title="" Language="C#" MasterPageFile="~/User/User.Master" AutoEventWireup="true" CodeBehind="Registration.aspx.cs" Inherits="FastFoodPractise.User.Registration" %>
                 ...
                 <div class=" form_container">
                     ...
                     <div>
                         ...
                         <asp:RegularExpressionValidator ID="revMobile" runat="server" ForeColor="Red"
                             ErrorMessage="Mobile No. must have 10 digits" Display="Dynamic" SetFocusOnError="true"
                             ValidationExpression="^[0-9]{10}$" ControlToValidate="txtMobile"></asp:RegularExpressionValidator>

                         <asp:TextBox ID="txtMobile" runat="server" CssClass="form-control"
                             placeholder="Enter Mobile No." ToolTip="Mobile No." TextMode="Number"></asp:TextBox>
                     </div>
             ...
             <div class="col-md-6">
                 <div class=" form_container">
                     ...
                     <div>
                         ...
                         <asp:RegularExpressionValidator ID="revPostCode" runat="server" ForeColor="Red"
                             ErrorMessage="Post/Zip Code No. must 6 digits" Display="Dynamic" SetFocusOnError="true"
             ...
             <div class=" row pl-4">
                 <div class="btn_box">
                     ...
                     <asp:Label ID="lblAlreadyUser" runat="server" CssClass="pl-3 text-black-100"
                         Text="Already registered? <a href='Login.aspx' class='badge-info'> Login here...</a>">
                     </asp:Label>
                 </div>
             </div>
