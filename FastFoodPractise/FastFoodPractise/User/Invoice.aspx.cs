...
namespace FastFoodPractise.User
{
    public partial class Invoice : System.Web.UI.Page
    {
        ...
        protected void lbDownloadInvoice_Click(object sender, EventArgs e)
        {
            try
            {
                string downloadPath = @"F:\New folder\order_invoice.pdf";
        ...
        void ExportTOPdf(DataTable dtblTable, string strPdfPath, string strHeader)
        {
            ...
            //  Paragraph p = new Paragraph(new Chunk(new iTextSharp.text.pdf.draw.LineSeparator(0.0F, 100.0F,Color.BLACK,Element)));
            document.Add(p);
