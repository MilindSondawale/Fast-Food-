<%@ Page Title="" Language="C#" MasterPageFile="~/User/User.Master" AutoEventWireup="true" CodeBehind="Cart.aspx.cs" Inherits="FastFoodPractise.User.Cart" %>
                             ...
                             <div class="quantity">
                                 <div class="pro-qty">
                                     ...
                                     <asp:RegularExpressionValidator ID="revQuantity" runat="server"
                                         ...
                                         ControlToValidate="txtQuantity" Display="Dynamic" SetFocusOnError="false"
